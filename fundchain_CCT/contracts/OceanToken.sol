...
// ocean-token\artifacts\@openzeppelin\contracts\token\ERC20\ERC20.sol
...
contract OceanToken is ERC20Capped, ERC20Burnable {
    ...
    constructor(uint256 cap, uint256 reward) ERC20("FundChain", "CCT") ERC20Capped(cap * (10 ** decimals())) {
