...
const Hero = ({ titleData, createCampaign }) => {
  ...
  const createNewCampaign = async (e) => {
    e.preventDefault();
    console.log(campaign); // Log the campaign object

    // Validate amount
    if (!campaign.amount || isNaN(campaign.amount) || Number(campaign.amount) <= 0) {
          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                Decentralized Crowdfunding on the Blockchain <br className="hidden md:block" />
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                FundChain revolutionizes crowdfunding by leveraging blockchain technology to create a transparent, secure, and decentralized platform.
              </p>
              <a
                href="/"
                aria-label=""
                ...
                <form>
                  ...
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      placeholder="Set a realistic fundraising goal"
                      required
                      type="text"
                      className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                      id="email"
